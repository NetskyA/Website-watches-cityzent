...
<body>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-dark text-light">
                    <h2 class="modal-title text-success" style="text-align: center;" id="exampleModalLabel">Successful
                        Payments</h2>
                ...
                <div class="modal-body bg-dark text-light">
                    <form>
                        ...
                        <div class="content">
                            Your item will be shipped within 3 days <br>
                            Order name: <br>
                            Address: <br>
                            Payment Method: <br>
                        </div>
    ...
    <div class="container-fluid" style="margin-top: 30px;">
        <div class="container-fluid body d-flex">
