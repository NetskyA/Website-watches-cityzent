...
<body>
    <div class="coverall">
        <div class="cover">
            <!--navbar-->
            <ul class="nav justify-content-center fs-5 fixed-top" id="navbar">
                ...
                <li class="nav-item ms-3">
                    <a class="nav3 nav-link text-dark disabled mt-3">Address</a>
                </li>
            </ul>
            <!--endnavbar-->
                    ...
                    <div class="isicontent" id="jmb">
                        <div class="container">
                            <div class="jumbotron mt-4 ps-2 pe-2" id="jbm">
                                <p class="display-4 fs-2 pt-1" style="text-align: center;">Wactches New Series</p>
                                <hr class="my-4">
                                    ...
                                    <div class="kiri">
                                        <div class="src d-flex justify-content-center mt-5">
                                            <form class="d-flex" role="search">
                                                <input class="form-control" style="width: 40vw;" type="search"
                                                    placeholder="Search..." aria-label="Search">
                                                <button class="btn btn-outline-dark ms-2" style="width: 10vw;"
