                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <a href="checkout.php" role="button" class="btn">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="35" fill="currentColor" class="bi bi-cart3" viewBox="0 0 16 16">
                                ...
                                <div class="kiri">
                                    <div class="container">
                                        ...
                                        <div class="src d-flex justify-content-center mt-3">
                                            ...
                                            <input class="form-control" type="search" placeholder="Search..." aria-label="Search" name="tekscari" id="cari1">
