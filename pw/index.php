                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <a href="checkout.php" role="button" class="btn">
                            <svg xmlns="http://www.w3.org/2000/svg" width="45" height="50" fill="currentColor" class="bi bi-cart4" viewBox="0 0 16 16" style="margin-right: 1vw;">
                                    ...
                                    <div class="atas">
                                        ...
                                        <div id="panel" style="width: 10vw; margin-left:1.3vw;">
                                            <div class="btn-group dropend fs-5">
                                                <input class="form-check-input me-1" type="checkbox" name="gdr" id="exampleRadios1" onclick="ajax(1)" value="1">
                                                <p class="brand" style="font-size: 1vw;">
                                                    Men
                                                </p>
                                            </div>
                                            <div class="btn-group dropend fs-5">
                                                <input class="form-check-input me-1" type="checkbox" name="gdr" id="exampleRadios1" onclick="ajax(1)" value="2">
                                                <p class="brand" style="font-size: 1vw;">
                                                    Women
                                                </p>
                                            </div>
                                            <div class="btn-group dropend fs-5">
                                                <input class="form-check-input me-1" type="checkbox" name="gdr" id="exampleRadios1" onclick="ajax(1)" value="3">
                                                <p class="brand" style="font-size: 1vw;">
                                                    For men and women
                                                </p>
                                            </div>
                                    ...
                                    <div class="bawah">
                                        ...
                                        <div id="panelss" style="width: 15vw; margin-left:1.3vw;">
                                            <div class="btn-group dropend fs-5 mb-3">
                                                <input type="search" style="width: 5vw;" id="minim" placeholder="Min" oninput="ajax(1)">
                                                <h3 style="margin: 3px;">-</h3>
                                                <input type="text" style="width: 5vw;" id="maks" placeholder="Max" oninput="ajax(1)">
                                            </div>
                                            <div class="btn-group dropend fs-5">
                                                <input class="form-check-input me-1" type="radio" name="prc" id="exampleRadios1">
                                                <p class="brand" style="font-size: 1vw;">
                                                    Rp 800k - 1000k
                                                </p>
                                            </div>
