        ...
        <div class="coverall">
            <div class="bungkus ">
                <div class="kiri d-flex justify-content-center">
                    <div class="isikiri" data-aos="zoom-in" data-aos-anchor="#example-anchor" data-aos-offset="500" data-aos-duration="1000">
                        <div class="jdl">
                            ...
                            <div class="fom" style="width: 50%;">
                                <form method="POST">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="username" id="" placeholder="User Name" class="form-control" id="exampleInputUsername" aria-describedby="emailHelp">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="sub d-flex">
                                        <ul class="nav nav-pills nav-justified d-flex mb-3" id="ex1" role="tablist">
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link text-light" id="tab-register" style="width: 7vw;" data-mdb-toggle="pill" href="index.php" role="tab" aria-controls="pills-register" aria-selected="false">Cancel
                                                </a>
                                            </li>

                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link active bg-secondary" style="width: 7vw;" id="tab-login" data-mdb-toggle="pill" href="admin.php" role="tab" aria-controls="pills-login" aria-selected="true">Login
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
