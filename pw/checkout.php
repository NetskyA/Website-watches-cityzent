                        ...
                        <div class="alamat" style="width: 100%; height:30vw;overflow:scroll;">
                            ...
                            <div class="bgks d-flex">
                                <div class="isinya mt-5" style="width: 30vw;">
                                    <form action="" method="POST">
                                        <div class="dropdown">
                                            <label for="exampleFormControlTextarea1">Shipping services</label>
                                            <a class="btn btn-light dropdown-toggle ms-3" href="#" role="button"
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li><a class="dropdown-item" href="#">J&T Express</a></li>
                                                <li><a class="dropdown-item" href="#">POS Indonesia</a></li>
                                                <li><a class="dropdown-item" href="#">SiCepat</a></li>
                                                <li><a class="dropdown-item" href="#">Pandu Logistics</a></li>
                                            </ul>
                                        </div>
                                        <div class="up">
                                            <div class="mb-3">
                                        ...
                                        <div class="up">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="nmfull"
                                                    aria-describedby="emailHelp">
                                            </div>
                                        </div>
                                        <div class="up">
                                        ...
                                        <textarea class="form-control" style="resize: none;max-height: 15vw;"
