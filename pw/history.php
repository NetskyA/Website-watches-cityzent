                    ...
                    <div class="collapse navbar-collapse fs-3" id="navbarNavDropdown">
                        <ul class="navbar-nav fs-5">
                            ...
                            <a href="index.php" style="text-decoration:none">
                                <p class="home text-dark" style="padding-top: 0.5vw;font-size:1.5vw; text-decoration: none;">History</p>
                            </a>
                        ...
                        <div class="sort">
                            ...
                            <div class="isi2">
                                <form action="" method="POST">
                                    <input style="border-radius:0.3vw; height:auto; width:8vw; border: 1px gray solid" type="date" name="dates" />
                                    <input type="submit" name="tgl" style="border-radius:0.3vw; height: auto; border: 1px gray solid;" value="Search">
                                </form>
                            </div>
                        </div>
